    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center gap-10">
                <div className="flex md:justify-center md:flex-row flex-col items-center flex-wrap w-full gap-10">
                    <div className="border-2 rounded-xl p-2">
                            ...
                            <img className="object-cover w-fit rounded-xl h-[30rem]" src={animu.images.jpg.large_image_url}></img>
                        </div>
                    <div className="flex flex-col items-center px-3">
                        <div className="flex flex-col border-2 gap-6 p-2 rounded-lg flex-wrap">
                            ...
                            <div className="flex flex-col md:flex-row gap-6">
                                ...
                                <div className="flex flex-col justify-evenly w-fit bg-blue-200 rounded-md px-2 py-2">
                                    <p className="text-xl font-bold">Alternate Titles</p>
                                    <div className="flex gap-2 w-[21rem] sm:w-[30rem] overflow-x-auto scroll py-1">
                                        {animu.titles.map((title) => {
                                        return (
                                            <p className="bg-gray-800 rounded-lg text-white p-1 whitespace-nowrap">{title.title}</p>
                                        )
                                        })}
                                    </div>
                                </div>
                            ...
                            <div className="flex gap-6 flex-col md:flex-row">
                                <div className="bg-blue-200 rounded-md p-2 flex flex-col justify-evenly h-24">                  
                                ...
                                <div className="bg-blue-200 rounded-md p-2 flex flex-col justify-evenly w-fit">
                ...
                <div className="border-2 md:max-w-[65.5rem] p-2 rounded-lg mx-auto">
            ...
            <div className="w-full h-fit bg-slate-900">
                    <p className="w-fit p-4 mx-auto text-white">*All stats and information are from <a className="font-bold hover:text-blue-500" href="https://myanimelist.net/">MyAnimeList</a>*</p>
            </div>
        </>
    )
    } else {
        ...
        <>
            ...
            <div className="flex flex-col items-center gap-10 flex-wrap">
                <div className="flex lg:justify-center:justify-evenly md:justify-center md:flex-row flex-col items-center flex-wrap w-full gap-10">
                    <div className="border-2 rounded-xl p-2">
                            <img className="object-cover h-fit md:w-fit rounded-xl md:h-[30rem]" src={animu.images.jpg.large_image_url}></img>
                        </div>
                    <div className="flex flex-col items-center">
                        <div className="flex flex-col border-2 w-fit gap-6 p-2 rounded-lg flex-wrap ">
                            <div className="w-full h-24 bg-gray-900 text-white rounded-lg p-2 flex flex-col justify-evenly">
                                    <h3 className="text-2xl">Information</h3>
                                    <p className="text-sm"> All stats from <a className="font-bold text-lg hover:text-blue-600" href="https://myanimelist.net/">MAL</a></p>
                                </div>
